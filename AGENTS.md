...
- During this experimentation phase, once a candidate is the validated best under the current strength, legality, and cost gates, promote it to the user-facing default promptly. Retain the prior version as an explicitly versioned rollback/control; do not keep a passing best candidate opt-in solely for extra roster-review conservatism.
