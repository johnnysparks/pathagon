...
```bash
python3 scripts/mine-adversarial-cases.py
```
...
```bash
python3 scripts/generate-adversarial-selfplay.py \
  --model research/runs/gnn/benchmark-7x7/generated/<campaign>/local-backup-20260826/artifacts/qadv-arbiter.onnx
```
