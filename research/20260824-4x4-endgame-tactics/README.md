...
```bash
.venv-pathagon-gnn/bin/python research/20260824-4x4-endgame-tactics/scripts/evaluate-4x4-endgame.py \
  --checkpoint research/20260824-4x4-endgame-tactics/workspace/candidate.pt \
  --budgets 0,32,128 \
  --solver-horizon 3
```
...
`research/20260824-gnn-cnn-lab/python/solver.py` provides a generic legal-move AND/OR search with:
